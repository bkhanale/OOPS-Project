...
void
LCS_display (vector < vector < char > >b, string X, int i, int j)
{
...
longestCommonSubsequence (string X, string Y)
{
    ...
    // At l_LCS[m][n] is then length of the longest common subsequence
    return l_LCS[m][n];
}
// Main function
int
main ()
{
    string DNA1 = "codechef";
    string DNA2 = "codeforces";
    string space = " ";
    DNA1.insert (0, space);
    DNA2.insert (0, space);
    cout << "Longest Common Subsequence is : ";
    cout << longestCommonSubsequence (DNA1, DNA2) - 1 << endl;
    return 0;
}
